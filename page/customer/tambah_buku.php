...
include"../../config.php";
	...
	$harga = $_POST['harga'];
	$stok = $_POST['stok'];
	$qryid = mysqli_query($con,"SELECT * FROM kategori where kategori='$kat'");
...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($con,"INSERT into buku set judul='$judul',id_ketegori='$id_kategori',pengarang='$pengarang',penerbit='$penerbit',halaman='$halaman',harga='$harga', gambar='$nama_file_baru', stok='$stok'");
